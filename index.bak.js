(function() {
    ...
    function main() {
      ...
      */
      ...
      function initCube(vPosition, vNormal, vTexCoord) {
      ...
      function initName(vPosition, vColor) {
        var vertexBufferObject = gl.createBuffer();
        gl.bindBuffer(gl.ARRAY_BUFFER, vertexBufferObject);
        gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(nameVertices), gl.STATIC_DRAW);
